...
STAR_IMAGE = pygame.transform.scale(pygame.image.load('...\Space-Dodge\STAR.png'), (15, 30))

# Upload the location of the rocket photo (ROCKET.png) here --->
ROCKET_IMAGE = pygame.transform.scale(pygame.image.load('...\Space-Dodge\ROCKET.png'), (PLAYER_WIDTH, PLAYER_HEIGHT))
...
def draw(player, elapsed_time, stars):
    ...
    WIN.blit(ROCKET_IMAGE, (player.x, player.y))
