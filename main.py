...
STAR_IMAGE = pygame.transform.scale(pygame.image.load('img/STAR.png'), (15, 30))

# Upload the location of the rocket photo (ROCKET.png) here --->
ROCKET_IMAGE = pygame.transform.scale(pygame.image.load('img/ROCKET.png'), (PLAYER_WIDTH, PLAYER_HEIGHT))
